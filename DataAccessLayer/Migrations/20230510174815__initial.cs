    ...
    public partial class _initial : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_UserWeightHistorys", x => x.Id);
                    table.ForeignKey(
                        name: "FK_UserWeightHistorys_Users_UserId",
                        column: x => x.UserId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UserWeightHistorys_UserId",
                table: "UserWeightHistorys",
                column: "UserId");
        }
